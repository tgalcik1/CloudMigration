...
node aws-iot-device-sdk-js-v2\samples\node\pub_sub\dist\index.js --endpoint a1a3dz02p289g4-ats.iot.us-east-2.amazonaws.com --ca_file root-CA.crt --key PC01.private.key --cert PC01.cert.pem --client_id sdk-nodejs-v2 --topic game/enumeration